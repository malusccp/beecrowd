...
# cada um deles com uma casa 
# decimal. Apresente a média ponderada para cada um destes conjuntos de 3 valores, sendo que o primeiro valor tem peso 2, o
#  segundo valor tem peso 3 e o terceiro valor 
# tem peso 5.
